...
B_2 := RestrictFunctorToFullSubcategoryOfSource( B, full_2 );
...
labels := [ "𝓞 (-2)", "𝓞 (-1)", "𝓞 (0)" ];
collection_1 := CreateStrongExceptionalCollection( image_B_1 : vertices_labels := labels );
...
# create strong full exceptional collection
labels := [ "𝓞 (-1)", "𝓞 (0)", "𝓞 (1)" ];
collection_2 := CreateStrongExceptionalCollection( image_B_2 : vertices_labels := labels );
