...
collection_ab := CreateStrongExceptionalCollection( o_012_ab : name_for_underlying_quiver := name_for_quiver,
...
collection_ho := CreateStrongExceptionalCollection( o_012_ho : name_for_underlying_quiver := name_for_quiver,
                                              name_for_endomorphism_algebra := name_for_algebra
                                          );
