...
c := CreateStrongExcepptionalCollection( image, [ "𝓞(1)", "𝓞(2)" ] );
...
o4 := [4]/rows * freyd * HomotopyCategory( qrows );

# or in the homotopy of additive closure over { 𝓞 (1), 𝓞 (2) } using the replacement functor
o4 := [4]/rows * freyd * HomotopyCategory( qrows ) * HomotopyCategory(c);

# or embedd it in the homotopy category of the ambient category of c
o4 := [4]/rows * freyd * HomotopyCategory( qrows ) * HomotopyCategory(c) * HomotopyCategory( AmbientCategory( c ) );

# or in the homotopy of additive closure over the algebroid associated to { 𝓞 (1), 𝓞 (2) }
o4 := [4]/rows * freyd * HomotopyCategory( qrows ) * HomotopyCategory(c) * HomotopyCategory( AdditiveClosure( algebroid_c ) );

# or in the homotopy of quiver rows associated to { 𝓞 (1), 𝓞 (2) }
o4 := [4]/rows * freyd * HomotopyCategory( qrows ) * HomotopyCategory(c) * HomotopyCategory( AdditiveClosure( algebroid_c ) ) * HomotopyCategory( QuiverRows( algebra_c ) );

# or again in the homotopy category of additive closure of full
o4 := [4]/rows * freyd * HomotopyCategory( qrows ) * HomotopyCategory(c) * HomotopyCategory( AdditiveClosure( full ) );

# or better in the homotopy category of graded rows
o4 := [4]/rows * freyd * HomotopyCategory( qrows ) * HomotopyCategory(c) * HomotopyCategory( AdditiveClosure( full ) ) * HomotopyCategory( rows );
