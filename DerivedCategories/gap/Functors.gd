...
#! @Arguments cat
#! @Returns a functor
DeclareAttribute( "DecompositionFunctorOfProjectiveQuiverRepresentations",
...
#! @Arguments cat
#! @Returns a functor
DeclareAttribute( "QuasiInverseOfDecompositionFunctorOfProjectiveQuiverRepresentations",
        IsQuiverRepresentationCategory );
...
DeclareAttribute( "DecompositionFunctorOfInjectiveQuiverRepresentations",
        IsQuiverRepresentationCategory );
...
#! @Arguments cat
#! @Returns a functor
DeclareAttribute( "QuasiInverseOfDecompositionFunctorOfInjectiveQuiverRepresentations",
        IsQuiverRepresentationCategory );
...
#! @Arguments alg
#! @Returns a functor
DeclareAttribute( "YonedaIsomorphismOntoFullSubcategoryOfCategoryOfQuiverRepresentations",
        IsAlgebroid );

DeclareAttribute( "YonedaIsomorphismOntoFullSubcategoryOfCategoryOfFunctors",
        IsAlgebroid );
...
#! @Arguments E
#! @Returns a functor
DeclareAttribute( "YonedaIsomorphismOntoFullSubcategoryOfCategoryOfQuiverRepresentations", IsStrongExceptionalCollection );
...
#! @Arguments E
#! @Returns a functor
DeclareAttribute( "InverseOfYonedaIsomorphismOntoFullSubcategoryOfCategoryOfQuiverRepresentations", IsStrongExceptionalCollection );
...
#! @Arguments alg
#! @Returns a functor
DeclareAttribute( "InverseOfYonedaIsomorphismOntoFullSubcategoryOfCategoryOfQuiverRepresentations",
        IsAlgebroid );

DeclareAttribute( "InverseOfYonedaIsomorphismOntoFullSubcategoryOfCategoryOfFunctors",
        IsAlgebroid );
