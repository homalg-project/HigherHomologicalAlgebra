  ...
  function( S )
    ...
    func_on_objects :=
      function( a )
        ...
        degs := ValueGlobal( "HomalgElementToListOfIntegers" )( DegreeList( UnderlyingCell( a ) )[ 1 ][ 1 ] );
...
function( S, i )
  ...
  AddObjectFunction( F,
    function( o )
      ...
      new_source_degs := List( [ 1 .. Length( source_degs ) ], j -> [ ShallowCopy( ValueGlobal( "HomalgElementToListOfIntegers" )( Degree( One( S ) ) ) ), source_degs[ j ][ 2 ] ] );
      ...
      new_range_degs := List( [ 1 .. Length( range_degs ) ], j -> [ ShallowCopy( ValueGlobal( "HomalgElementToListOfIntegers" )( Degree( One( S ) ) ) ), range_degs[ j ][ 2 ] ] );
...
InstallMethod( DecomposeMorphismBetweenGradedRowsOfRankOneOverCoxRingOfProductOfProjectiveSpaces,
  ...
  function( alpha )
    ...
    source_degs := ValueGlobal( "HomalgElementToListOfIntegers" )( DegreeList( Source( alpha ) )[ 1 ][ 1 ] );
    
    sources := ListN( source_degs, S!.factor_rings, { deg, ring } -> GradedRow( [ [ [ deg ], 1 ] ], ring ) );
    
    range_degs := ValueGlobal( "HomalgElementToListOfIntegers" )( DegreeList( Range( alpha ) )[ 1 ][ 1 ] );
