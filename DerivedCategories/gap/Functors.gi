...
InstallMethod( ImageOfFunctor,
  ...
  function( I )
    ...
    name := Concatenation( r[ 1 ], "Full subcategory( ", r[ 2 ], Name( R ), r[ 1 ],
        " ) generated by applying a functor on ", String( Size( images_obj_C ) ), " objects", r[ 2 ] );
...
InstallMethod( ImageOfFullyFaithfullFunctor,
  ...
  function( I )
    ...
    name := Concatenation( r[ 1 ], "Full subcategory( ", r[ 2 ], Name( R ), r[ 1 ],
        " ) generated by applying a fully faithfull functor on ", String( Size( SetOfKnownObjects( image ) ) ), " objects", r[ 2 ] );
    ...
    if HasIsAbelianCategory( C ) and IsAbelianCategory( C ) then
      ...
      if IsCapFullSubcategory( D ) then
        ...
        if IsCapFullSubcategoryGeneratedByFiniteNumberOfObjects( U ) then
          ...
          name := "Isomorphism functor from ProSetAsCategory into full subcategory generated by all its objects" ;
