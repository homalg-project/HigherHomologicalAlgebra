...
#! @Arguments E
#! @Returns 
DeclareAttribute( "FullSubcategory", IsStrongExceptionalCollection );

#! @Description
#!  Returns the ambient category of <C>FullSubcategory</C>(<A>E</A>).
#! @Arguments E
#! @Returns 
...
#! @Description
#!  Returns the additive closure of the <C>FullSubcategory</C>(<A>E</A>).
#! @Arguments E
...
#! @Description
#!  Returns the additive closure of the <C>FullSubcategory</C>(<A>E</A>) as an additive
...
DeclareGlobalFunction( "RandomQuiverAlgebraWhoseIndecomposableProjectiveRepsAreStrongExceptionalCollection" );
...
#! @Arguments cat
#! @Returns a full subcategory
DeclareAttribute( "FullSubcategoryGeneratedByIndecomposableProjectiveObjects",
        IsCapCategory );
...
#! @Arguments cat
#! @Returns a full subcategory
DeclareAttribute( "FullSubcategoryGeneratedByIndecomposableInjectiveObjects",
        IsCapCategory );
