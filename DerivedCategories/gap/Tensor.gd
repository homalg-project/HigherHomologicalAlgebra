...
DeclareAttribute( "TensorFunctorFromCategoryOfFunctors", IsStrongExceptionalCollection );
...
#! @Returns a functor
DeclareAttribute( "TensorFunctorFromCategoryOfQuiverRepresentations",
...
#!  <C>FullSubcategoryGeneratedByIndecomposableProjectiveObjects</C>$(\mathrm{mod}\mbox{-}\mathrm{End}(\oplus_i E_i)) \to C$.
#! @Arguments collection
#! @Returns a functor
DeclareAttribute( "TensorFunctorFromCategoryOfQuiverRepresentationsOnIndecomposableProjectiveObjects",
        IsStrongExceptionalCollection );
...
#! @Arguments collection
#! @Returns a functor
DeclareAttribute( "TensorFunctorFromCategoryOfQuiverRepresentationsOnProjectiveObjects",
        IsStrongExceptionalCollection );
