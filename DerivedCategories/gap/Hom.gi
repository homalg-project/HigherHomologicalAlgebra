...
InstallMethod( HomFunctorToCategoryOfQuiverRepresentationsOnIndecInjectiveObjects,
  ...
  function( collection )
    ...
    return CreateAdditiveFunctorByTwoFunctions( name, inj_indec, reps, cell_func, cell_func );
...
InstallMethod( HomFunctorToCategoryOfQuiverRepresentationsOnIndecProjectiveObjects,
  ...
  function( collection )
    ...
    return CreateAdditiveFunctorByTwoFunctions( name, proj_indec, reps, cell_func, cell_func );
...
InstallMethod( HomFunctorToCategoryOfQuiverRepresentationsOnBaseCategory,
  ...
  function( collection )
    ...
    return CreateAdditiveFunctorByTwoFunctions( name, B, reps, cell_func, cell_func );
