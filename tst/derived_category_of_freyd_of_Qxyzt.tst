...
gap> alpha_1 := InterpretMorphismFromDinstinguishedObjectToHomomorphismStructureAsMorphism( m1, m2, alpha_1 );;
gap> alpha_2 := InterpretMorphismFromDinstinguishedObjectToHomomorphismStructureAsMorphism( m1, m2, alpha_2 );;
