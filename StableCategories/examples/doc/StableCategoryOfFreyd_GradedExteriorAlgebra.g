...
St_Grmod_EEE := StableCategoryByClassOfColiftingObjects( Grmod_EEE : FinalizeCategory := false );
ADD_TRIANGULATED_STRUCTURE( St_Grmod_EEE );
Finalize( St_Grmod_EEE );

St_Gpres_EEE := StableCategoryByClassOfColiftingObjects( Gpres_EEE : FinalizeCategory := false );
