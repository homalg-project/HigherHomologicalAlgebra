...
function( homotopy_category, n )
  ...
  T := BrutalTruncationBelowFunctor( complex_cat, n );
  
  name := Concatenation( "Endofunctor of brutal truncation from below (C -> C^> ", String( n ), ") in ", Name( homotopy_category ) );
...
function( homotopy_category, n )
  ...
  T := BrutalTruncationAboveFunctor( complex_cat, n );
  
  name := Concatenation( "Endofunctor of brutal truncation from above (C -> C^<= ", String( n ), ") in ", Name( homotopy_category ) );
