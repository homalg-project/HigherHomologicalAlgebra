...
#! @Description
#! The argument is a category of quiver representations over some finite dimensional quiver algebra. The output the full subcategory
#! generated by the indecomposable projective representations.
#! @Arguments cat
#! @Returns a full subcategory
...
#! @Description
#! The argument is a category of quiver representations over some finite dimensional quiver algebra. The output the full subcategory
#! generated by the indecomposable injectives representations.
#! @Arguments cat
#! @Returns a full subcategory
...
#! @Description
#! The argument is a category of quiver representations over some finite dimensional quiver algebra. The output is an isomorphism
