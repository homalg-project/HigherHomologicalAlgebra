...
InstallMethod( FullSubcategoryGeneratedByProjectiveObjects,
  ...
  function( cat )
    ...
    full := FullSubcategory( cat, "Full additive subcategory generated by projective objects in "
...
InstallMethod( FullSubcategoryGeneratedByInjectiveObjects,
  ...
  function( cat )
    ...
    full := FullSubcategory( cat, "Full additive subcategory generated by injective objects in "
              : FinalizeCategory := false, is_additive := true );
