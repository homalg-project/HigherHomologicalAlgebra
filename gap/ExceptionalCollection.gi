...
InstallMethod( FullSubcategoryGeneratedByIndecProjectiveObjects,
          [ IsCapFullSubcategory ],
  cat -> FullSubcategoryGeneratedByIndecProjectiveObjects( AmbientCategory( cat ) ) 
);
...
InstallMethod( FullSubcategoryGeneratedByIndecProjectiveObjects,
          [ IsCapCategory ],
  function( cat )
    local full, full_subcategory_by_projs, projs, r, name;
...
InstallMethod( FullSubcategoryGeneratedByIndecInjectiveObjects,
          [ IsCapFullSubcategory ],
  cat -> FullSubcategoryGeneratedByIndecInjectiveObjects( AmbientCategory( cat ) ) 
);
...
InstallMethod( FullSubcategoryGeneratedByIndecInjectiveObjects,
          [ IsCapCategory ],
  function( cat )
    local full, full_subcategory_by_injs, injs, name, r;
...
InstallMethod( FullSubcategoryGeneratedByProjectiveObjects,
  ...
  function( cat )
    ...
    name := Concatenation( r[ 1 ], "Full additive subcategory generated by projective objects of ( ", r[ 2 ], Name( cat ), r[ 1 ], " )", r[ 2 ] );
...
InstallMethod( FullSubcategoryGeneratedByInjectiveObjects,
  ...
  function( cat )
    ...
    name := Concatenation( r[ 1 ], "Full additive subcategory generated by injective objects of ( ", r[ 2 ], Name( cat ), r[ 1 ], " )", r[ 2 ] );
