...
###
#BindGlobal( "ReplacementFunctor",
#  function( collection )
#    local ambient_cat, HP, HH, TP, D, Ho_D, TT, Rep, name;
#    
...
#                ] );
#    
#    Rep := PreCompose( [ HH, TT ] );
#    
#    name := "Replacement functor in terms of exceptional collection";
#    
#    Rep!.Name := name;
#    
#    return Rep;
