...
#####################################################################
#
# the following functors should be moved to FreydCategories package!
#
#####################################################################
...
InstallMethod( IsomorphismFunctorFromQuiverRowsIntoAdditiveClosureOfAlgebroid,
  ...
  function( QRowsA, additive_closure )
    local ring_QRowsA, ring_additive_closure, is_rationals, is_integers,
      algebroid, object_in_algebroid, morphism_in_algebroid, name, F;
       
    if not IsPackageMarkedForLoading( "Bialgebroids", ">= 2019.12.01" ) then
      
      Error( "The package Bialgebroids with a version >= 2019.12.01 is required for this operation\n" );
    ...
    object_in_algebroid := ValueGlobal( "ObjectInAlgebroid" );
    
    morphism_in_algebroid := ValueGlobal( "MorphismInAlgebroid" );
    ...
    AddObjectFunction( F,
      function( a )
        ...
        vertices := List( vertices, v -> [ object_in_algebroid( algebroid, v[ 1 ] ), v[ 2 ] ] );
      ...
      function( s, alpha, r )
        ...
        if IsEmpty( matrix ) then
          ...
          matrix := ListN( objects, matrix,
                      { o, m } -> ListN( o, m,
                        { v, e } -> morphism_in_algebroid( v[ 1 ], e, v[ 2 ] ) )
                          );
...
InstallMethod( IsomorphismFunctorFromAdditiveClosureOfAlgebroidIntoQuiverRows,
  ...
  function( additive_closure, QRowsA )
    local ring_QRowsA, ring_additive_closure, is_rationals, is_integers,
            algebroid, underlying_vertex, underlying_quiver_algebra_element, name, F;
    ...
    underlying_vertex := ValueGlobal( "UnderlyingVertex" );
    
    underlying_quiver_algebra_element := ValueGlobal( "UnderlyingQuiverAlgebraElement" );
    ...
    AddObjectFunction( F,
      function( a )
        ...
        vertices := List( ObjectList( a ), o -> [ underlying_vertex( o ), 1 ] );
    ...
    AddMorphismFunction( F,
      function( s, alpha, r )
        ...
        matrix := List( matrix, row -> List( row, underlying_quiver_algebra_element ) );
...
InstallMethod( IsomorphismFunctorFromQuiverRows,
  ...
  function( additive_closure )
    ...
    if not ValueGlobal( "IsAlgebroid" )( algebroid ) then
...
InstallMethod( IsomorphismFunctorFromAdditiveClosureOfAlgebroid,
  ...
  function( QRowsA )
    ...
    if IsIntegers( ring ) or ( HasIsIntegersForHomalg( ring ) and IsIntegersForHomalg( ring ) ) then
      ...
      additive_closure := AdditiveClosure( ValueGlobal( "Algebroid" )( A, true ) );
      
      return IsomorphismFunctorFromAdditiveClosureOfAlgebroidIntoQuiverRows( additive_closure, QRowsA );
      
    else
      
      additive_closure := AdditiveClosure( ValueGlobal( "Algebroid" )( A ) );
