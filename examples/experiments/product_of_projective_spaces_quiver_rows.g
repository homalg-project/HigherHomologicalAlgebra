...
B_1 := BeilinsonFunctorIntoHomotopyCategoryOfQuiverRows( S_1 );
B_1 := RestrictFunctorToFullSubcategoryOfSource( B_1, full_1 );
C_1 := AsCapCategory( Range( B_1 ) );
QRows_1 := DefiningCategory( C_1 ); 
...
B_2 := BeilinsonFunctorIntoHomotopyCategoryOfQuiverRows( S_2 );
B_2 := RestrictFunctorToFullSubcategoryOfSource( B_2, full_2 );
C_2 := AsCapCategory( Range( B_2 ) );
QRows_2 := DefiningCategory( C_2 );

I := FunctorFromProductOfQuiverRowsOntoQuiverRowsOfTensorProductAlgebra( QRows_1, QRows_2 ); 
